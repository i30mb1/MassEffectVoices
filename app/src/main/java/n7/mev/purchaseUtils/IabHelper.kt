...
import n7.mev.purchaseUtils.IabException
 ...
 * call [.disposeWhenFinished] to ensure that any in-progress operation
...
class IabHelper(ctx: Context?, base64PublicKey: String?) {
    ...
    private var mSubscriptionUpdateSupported = false
    ...
    private var mPurchasingItemType: String? = null
    ...
    @Throws(IabAsyncInProgressException::class)
    fun launchPurchaseFlow(act: Activity?, sku: String, requestCode: Int, listener: OnIabPurchaseFinishedListener) {
        launchPurchaseFlow(act, sku, requestCode, listener, "")
    }

    @Throws(IabAsyncInProgressException::class)
    private fun launchPurchaseFlow(act: Activity?, sku: String, requestCode: Int,
    ...
    @Throws(IabAsyncInProgressException::class)
    private fun launchSubscriptionPurchaseFlow(act: Activity, sku: String, requestCode: Int,
                                               listener: OnIabPurchaseFinishedListener, extraData: String) {
    ...
    private fun getResponseCodeFromBundle(b: Bundle): Int {
        ...
        } else if (o is Int) o else if (o is Long) o.toLong().toInt() else {
    ...
    private fun consumeAsyncInternal(purchases: List<Purchase?>,
        ...
        Thread(Runnable {
            ...
            for (purchase in purchases) {
                try {
                    consume(purchase)
                    results.add(IabResult(BILLING_RESPONSE_RESULT_OK, "Successful consume of sku " + purchase.getSku()))
                } catch (ex: IabException) {
    ...
    companion object {
        ...
        private const val BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE = 3

        // IAB Helper error codes
        private const val IABHELPER_ERROR_BASE = -1000
        private const val IABHELPER_REMOTE_EXCEPTION = -1001
        private const val IABHELPER_BAD_RESPONSE = -1002
        private const val IABHELPER_VERIFICATION_FAILED = -1003
        private const val IABHELPER_SEND_INTENT_FAILED = -1004
        private const val IABHELPER_USER_CANCELLED = -1005
        private const val IABHELPER_UNKNOWN_PURCHASE_RESPONSE = -1006
        private const val IABHELPER_MISSING_TOKEN = -1007
        private const val IABHELPER_UNKNOWN_ERROR = -1008
        private const val IABHELPER_SUBSCRIPTIONS_NOT_AVAILABLE = -1009
        private const val IABHELPER_INVALID_CONSUMPTION = -1010
        private const val IABHELPER_SUBSCRIPTION_UPDATE_NOT_AVAILABLE = -1011

        // Keys for the responses from InAppBillingService
        private const val RESPONSE_CODE = "RESPONSE_CODE"
        private const val RESPONSE_GET_SKU_DETAILS_LIST = "DETAILS_LIST"
        ...
        private const val RESPONSE_INAPP_ITEM_LIST = "INAPP_PURCHASE_ITEM_LIST"
        private const val RESPONSE_INAPP_PURCHASE_DATA_LIST = "INAPP_PURCHASE_DATA_LIST"
        private const val RESPONSE_INAPP_SIGNATURE_LIST = "INAPP_DATA_SIGNATURE_LIST"
        private const val INAPP_CONTINUATION_TOKEN = "INAPP_CONTINUATION_TOKEN"
        private const val ITEM_TYPE_SUBS = "subs"

        // some fields on the getSkuDetails response bundle
        private const val GET_SKU_DETAILS_ITEM_LIST = "ITEM_ID_LIST"
